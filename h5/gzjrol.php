...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark menu">
    ...
    <br>
    <h2 class="carb">JUEGOS DE ROL</h2>
        ...
        <div class="col-md-12">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/Juegos/Dungeons and Dragons.png" class="d-block w-100 cent" alt="Dungeons And Dragons">
                    <div class="carousel-caption d-none d-md-block">
                        <h2 class="carb">DUNGEONS AND DRAGONS</h2>
                        <p class="carb">Sumérgete en el juego de rol más íconico del mundo.</p>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="img/Juegos/Uno.jpg" class="d-block w-100 cent" alt="Uno">
                    <div class="carousel-caption d-none d-md-block">
                        <h2 class="carb">UNO</h2>
                        <p class="carb">Se el primero en deshacerte de tus cartas.</p>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="img/Juegos/Scrabble.jpg" class="d-block w-100 cent" alt="Scrabble">
                    <div class="carousel-caption d-none d-md-block">
                        <h2 class="carb">SCRABBLE</h2>
                        <p class="carb">Cada letra cuenta.</p>
                    </div>
                </div>
            </div>
