...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark menu">
    ...
    <br>
    <h2 class="carb">JUEGOS FAMILIARES</h2>
        ...
        <div class="col-md-12">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/Juegos/King of Tokyo.png" class="d-block w-100 cent" alt="King of Tokyo">
                    <div class="carousel-caption d-none d-md-block">
                        <h2 class="carb">KING OF TOKYO</h2>
                        <p class="carb">Combate entre kaijus íconicos por control de Tokyo.</p>
                    </div>
                </div>
