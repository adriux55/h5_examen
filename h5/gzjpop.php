...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark menu">
    ...
    <br>
    <h2 class="cary">JUEGOS POPULARES</h2>
        ...
        <div class="col-md-12">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/Juegos/Monopoly.jpg" class="d-block w-100 cent" alt="Monopoly">
                    <div class="carousel-caption d-none d-md-block">
                        <h2 class="cary">MONOPOLIO</h2>
                        <p class="cary">El emocionante juego de propiedades inmoviliarias.</p>
                    </div>
                </div>
