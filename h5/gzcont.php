...
<body>
  ...
  <div class="container wrapper">
    <div class="row">
      <div class="col-sm-3">
        <p>
          <i class="bi bi-envelope"></i> geekzonebolivia
        </p>
      </div>
      <div class="col-sm-9 btxb">
        <div class="row">
          <div class="col">
            <p>
              ...
              Nombres
              <br>
              <input type="text" name="Nombres" id="txtPaterno" class="form-control">
              <br>
              Apellido
              <br>
              <input type="text" name="Apellido" id="txtPaterno" class="form-control">
              <br>
              Correo Electrónico
              <br>
              <input type="text" name="Correo Electrónico" id="txtPaterno" class="form-control">
            </p>
          </div>
        </div>
      </div>
