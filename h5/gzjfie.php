...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark menu">
    ...
    <br>
    <h2 class="cary">JUEGOS DE FIESTA</h2>
        ...
        <div class="col-md-12">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/Juegos/Wavelength.png" class="d-block w-100 cent" alt="Wavelength">
                    <div class="carousel-caption d-none d-md-block">
                        <h2 class="cary">WAVELENGTH</h2>
                        <p class="cary">¿Realmente crees que conoces lo que piensan tus amigos?</p>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="img/Juegos/Uno.jpg" class="d-block w-100 cent" alt="Uno">
                    <div class="carousel-caption d-none d-md-block">
                        <h2 class="cary">UNO</h2>
